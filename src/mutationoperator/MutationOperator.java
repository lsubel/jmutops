...
public abstract class MutationOperator{
	...
	/**
	 * Internal counter which collects the number of detected matchings within a {@link mutationoperator.MutationOperator#check(ASTNode, ASTNode) check(ASTNode, ASTNode)} call.
	 */
